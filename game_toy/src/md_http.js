...
md_http.use("/toy", function(req, res, next){
...
md_http.use("/player", function(req, res, next){
	...
	// 	if(err) { return res.json({ret_code : -2, ret_msg : "db error"});}
...
md_http.use("/toy", require("./router/toys"))
md_http.use("/player", require("./router/players"))
